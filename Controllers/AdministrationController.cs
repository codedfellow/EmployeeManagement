        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted because there are users currently assigned to this" +
                        " role. If you really want to delete this role, please remove all the users in this role and then try " + 
                        "to delete the role";
                    return View("Error");
                }
